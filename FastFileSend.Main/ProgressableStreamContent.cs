...
namespace FastFileSend.Main
{
    internal class ProgressableStreamContent : HttpContent
    {
        ...
        public ProgressableStreamContent(Stream content, IProgress<long> progress) : this(content, defaultBufferSize, progress) { }

        public ProgressableStreamContent(Stream content, int bufferSize, IProgress<long> progress)
        {
            if (content == null)
            {
